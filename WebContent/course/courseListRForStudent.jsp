	...
	<br><br><br>
		...
		<div>
			<div class="row">
				...
				<div class="col-md-4">
					<div class="page-header">
						  <h1><span class="glyphicon glyphicon-list-alt" style="vertical-align: middle;"></span>&nbsp;<font color="blue">${sessionScope.id}</font>님의 신청과목</h1>
					</div>
				</div>
				<div class="col-md-1">
		            <div class="panel status panel-danger">
		                <div class="panel-heading">
		                    ...
		                    <c:if test="${dsStudentregList[0].COURSE_TOTAL_SCORE != null}">${dsStudentregList[0].COURSE_TOTAL_SCORE}</c:if>
		                    <c:if test="${dsStudentregList[0].COURSE_TOTAL_SCORE == null}">0</c:if>
		                    </h1>
		                </div>
				                ...
				                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
				                    <thead>
				                        <tr>
				                            ...
				                            <th style="text-align: center; vertical-align: middle; width: 50px;">신청인원</th>
				                            ...
				                            <th style="text-align: center; vertical-align: middle; width: 50px;">과목분류</th>
				                    ...
				                    <tbody>
				                    	<c:forEach items="${dsCourseList}" var="dsCourseList" varStatus="courseIdx">
				                         <tr>
				                         	<td style="text-align: center; vertical-align: middle;">${dsCourseList.COURSE_CODE}</td>
				                            ...
				                            <td style="text-align: center; vertical-align: middle;">${dsCourseList.COURSE_CUR_NUMBER} / ${dsCourseList.COURSE_MAX_NUMBER}</td>
				                            ...
				                            <td style="text-align: center; vertical-align: middle;">${dsCourseList.COURSE_CATEGORY_CD_NM}</td>
			                ...
			                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
			                    ...
			                    <tbody>
			                    	<c:forEach items="${dsStudentregList}" var="dsStudentregList" varStatus="studentregIdx">
			                         <tr>
			                         	<td style="text-align: center; vertical-align: middle;">${dsStudentregList.COURSE_CODE}</td>
